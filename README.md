...
-   Visualizes **final approach glideslope** for each aircraft. Each descent segment is rated by a color.
  - Also identifies if the aircraft bounces the touchdown!
    ...
    <p align="left">
    <img src="[Results/[2025.08.31] Phoenix_landing_3.png](https://github.com/fardad-d1ce/Landing-Rating/blob/main/Results/%5B2025.08.31%5D%20Phoenix_landing_3.png?raw=true)" alt="Touchdown Plot" width="600"/>
    </p>
